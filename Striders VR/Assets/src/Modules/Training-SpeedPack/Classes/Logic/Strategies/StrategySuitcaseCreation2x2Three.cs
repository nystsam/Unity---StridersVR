...
{
	public class StrategySuitcaseCreation2x2Three : IStrategySuitcaseCreation
	{
		...
		public StrategySuitcaseCreation2x2Three (GameObject suitcaseContainer)
		{
		...
		private void addIndicatedParts(ref Suitcase newSuitcase)
		{
			...
			{
				if(_attachedRandom == 0)
					newSuitcase.addSuitcasePartMain(this.suitcasePartData.getSuitcasePart2x2 ());
				else
					newSuitcase.addSuitcasePart(this.suitcasePartData.getSuitcasePart2x2 ());
			}
		}
	}
}
