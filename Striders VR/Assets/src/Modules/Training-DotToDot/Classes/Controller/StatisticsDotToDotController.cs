...
public class StatisticsDotToDotController : MonoBehaviour {

	public static StatisticsDotToDotController Current;

	public TextMesh Total;
	public TextMesh Hits;
	public TextMesh Errors;
	public TextMesh AverageTime;
	public TextMesh Revelations;

	private List<GameObject> activityBars;

	private StatisticsDotToDot statistics;

	private List<ActivityDotToDot> modelResults;

	public StatisticsDotToDotController()
	{
		Current = this;
	}

	public void addNewResult(ActivityDotToDot result)
	{
		this.modelResults.Add(result);
	}
	...
	{
		foreach(ActivityDotToDot adtd in this.modelResults)
		{
	...
	void Start () 
	{
		...
		this.statistics = new StatisticsDotToDot();
		this.loadActivities();
