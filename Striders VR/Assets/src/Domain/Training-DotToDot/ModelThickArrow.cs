...
{
	[System.Serializable]
	public class ModelThickArrow : FigureModel
	{
		public ModelThickArrow (string figureName, GameObject prefab) : base(figureName, prefab)
		{
		}
		...
		public override void updateNeighbourVectorList(GameObject containerLocal, GameObject gameFigureGame)
		{
			...
			_secondNeighbour = this.stripesList [4];
			...
			_vertex = this.stripesList [4];
			_firstNeighbour = this.stripesList [3];
